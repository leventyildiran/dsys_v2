...
class FaturaPdfUretici {
  ...
  static Future<Uint8List> generatePdf({
    ...
    required String nakliYekunUstMetin,
    required String nakliYekunAltMetin,
  ...
  static Future<Uint8List> generateBatchPdf({
    required List<FaturaModel> invoices,
    required Map<String, Offset> coordinates,
    required double kalemSatirAraligi,
    required double matbuFontBoyutu,
    required double globalOffsetDx,
  ...
  static Future<Uint8List> _generatePdfCore({
    required List<FaturaModel> invoices,
    required Map<String, Offset> coordinates,
    required double kalemSatirAraligi,
    required double matbuFontBoyutu,
            ...
            pw.Page(
              ...
              build: (context) {
                ...
                for (int i = 0; i < invoice.ekstraNotlar.length; i++) {
                  final not = invoice.ekstraNotlar[i].trim();
                  if (not.isNotEmpty && coordinates.containsKey('ekstraNot_$i')) {
                    children.add(pw.Positioned(
