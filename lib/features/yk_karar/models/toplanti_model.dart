/// Toplantı Gündem Modeli (v2).
///
/// Yürütme Kurulu toplantı gündeminin karar maddelerini yönetir.
/// Firestore yolu: `universiteler/{uniId}/toplantilar/{toplantiId}`
class ToplantiModel {
  const ToplantiModel({
    required this.id,
...
enum GundemTuru {
  ...
  fiyatTarifesi('fiyat_tarifesi', 'Fiyat Tarifesi'),
  butceOnay('butce_onay', 'Bütçe Onay'),
  malSatis('mal_satis', 'Mal Satış'),
  diger('diger', 'Diğer');
